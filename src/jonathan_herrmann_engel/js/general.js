...
const STRINGS = {
	en:{
		...
		platformWebSettingsIframeApplyAndClose: "Apply and close", platformWindowsLinkError: "Error! Couldn't open link.", platformWindowsAppScreenFeedback: "Feedback", platformWindowsAppScreenChangelog: "Changelog"},
	de:{
		langName: "Deutsch",
		...
		platformWebSettingsIframeApplyAndClose: "Anwenden und schließen", platformWindowsLinkError: "Fehler - Link konnte nicht geöffnet werden.", platformWindowsAppScreenFeedback: "Feedback", platformWindowsAppScreenChangelog: "Neuigkeiten"}};
